...
INVALID_STATUS_ERROR_TEXT = f"Invalid '{FIELD_STATUS}' value. Allowed: '{STATUS_ACTIVE}', '{STATUS_ATTENDED}', '{STATUS_CANCELLED}', '{STATUS_MISSED}'"
INVALID_PATIENT_ID_ERROR_TEXT = f'Invalid {FIELD_PATIENT!r} ID. Expected 10-digit number'
INVALID_CLINICIAN_ERROR_TEXT = f'Invalid {FIELD_CLINICIAN!r} value'
INVALID_DEPARTMENT_ERROR_TEXT = f'Invalid {FIELD_DEPARTMENT!r} value'
MISSING_POSTCODE_ERROR_TEXT = f'Missing {FIELD_POSTCODE}'
