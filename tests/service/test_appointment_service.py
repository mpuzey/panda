...
class TestAppointmentService(unittest.TestCase):
    def setUp(self):
        ...
        self.appointment_service = AppointmentService(self.mock_mongo)
    ...
    def test_create_appointment_success(self):
        ...
        self.mock_mongo.create.assert_called_once_with(self.valid_appointment)
    ...
    def test_update_appointment_success(self):
        ...
        self.mock_mongo.update.assert_called_once_with({'id': '01542f70-929f-4c9a-b4fa-e672310d7e78'}, self.valid_appointment)
    ...
    def test_update_appointment_database_error(self):
        ...
        self.assertEqual(response['status'], 500)
        self.assertEqual(response['error'], ERR_COULD_NOT_UPDATE_APPOINTMENT)

    def test_get_appointment_success(self):
        """Test successful appointment retrieval."""
        self.mock_mongo.get.return_value = self.valid_appointment
        
        response = self.appointment_service.get_appointment('01542f70-929f-4c9a-b4fa-e672310d7e78')
        
        self.assertEqual(response['status'], HTTP_200_OK)
        self.assertEqual(response['appointment'], self.valid_appointment)
        self.mock_mongo.get.assert_called_once_with({'id': '01542f70-929f-4c9a-b4fa-e672310d7e78'})
    ...
    def test_delete_appointment_success(self):
        ...
        self.mock_mongo.delete.assert_called_once_with({'id': '01542f70-929f-4c9a-b4fa-e672310d7e78'})
    ...
    def test_get_all_appointments_success(self):
        ...
        self.mock_mongo.getAll.return_value = mock_appointments
