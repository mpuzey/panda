...
from constants import UK_POSTCODE_VALIDATION_REGEX, APPOINTMENT_FIELD_PATIENT, APPOINTMENT_FIELD_STATUS, APPOINTMENT_FIELD_TIME, APPOINTMENT_FIELD_DURATION, \
    APPOINTMENT_FIELD_CLINICIAN, APPOINTMENT_FIELD_DEPARTMENT, APPOINTMENT_FIELD_POSTCODE, APPOINTMENT_FIELD_ID, STATUS_ACTIVE, STATUS_ATTENDED, STATUS_CANCELLED, \
