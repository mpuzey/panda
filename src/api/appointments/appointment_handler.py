...
from constants import APPOINTMENT_FIELD_STATUS, PANDA_RESPONSE_FIELD_ERROR, PANDA_RESPONSE_FIELD_MESSAGE, \
    APPOINTMENT_SERVICE_FIELD_VALIDATION_ERRORS, APPOINTMENT_SERVICE_FIELD_ERROR, APPOINTMENT_SERVICE_FIELD_STATUS, \
